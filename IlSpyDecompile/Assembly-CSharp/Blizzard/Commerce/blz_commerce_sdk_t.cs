...
namespace Blizzard.Commerce
{
	public class blz_commerce_sdk_t : IDisposable
	{
		...
		protected virtual void Dispose(bool disposing)
		{
			lock (this)
			{
				if (swigCPtr.Handle != IntPtr.Zero)
				{
					...
					{
						swigCMemOwn = false;
						battlenet_commercePINVOKE.delete_blz_commerce_sdk_t(swigCPtr);
					}
		...
		public blz_commerce_sdk_t()
			: this(battlenet_commercePINVOKE.new_blz_commerce_sdk_t(), cMemoryOwn: true)
		{
		}
	}
}
