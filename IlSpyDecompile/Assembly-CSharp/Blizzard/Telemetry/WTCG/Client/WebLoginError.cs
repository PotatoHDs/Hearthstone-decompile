...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class WebLoginError : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (webLoginError == null)
			{
				return false;
			}
			if (HasPlayer != webLoginError.HasPlayer || (HasPlayer && !Player.Equals(webLoginError.Player)))
			{
				return false;
			}
			if (HasDeviceInfo != webLoginError.HasDeviceInfo || (HasDeviceInfo && !DeviceInfo.Equals(webLoginError.DeviceInfo)))
			{
				return false;
			}
			return true;
		...
		public static WebLoginError DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, webLoginError);
