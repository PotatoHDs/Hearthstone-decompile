...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class AttributionLogin : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (attributionLogin == null)
			{
				return false;
			}
			if (HasApplicationId != attributionLogin.HasApplicationId || (HasApplicationId && !ApplicationId.Equals(attributionLogin.ApplicationId)))
			{
				return false;
			}
			if (HasDeviceType != attributionLogin.HasDeviceType || (HasDeviceType && !DeviceType.Equals(attributionLogin.DeviceType)))
			{
				return false;
			}
			if (HasFirstInstallDate != attributionLogin.HasFirstInstallDate || (HasFirstInstallDate && !FirstInstallDate.Equals(attributionLogin.FirstInstallDate)))
			{
				return false;
			}
			if (HasBundleId != attributionLogin.HasBundleId || (HasBundleId && !BundleId.Equals(attributionLogin.BundleId)))
			{
				return false;
			}
			if (HasIdentifier != attributionLogin.HasIdentifier || (HasIdentifier && !Identifier.Equals(attributionLogin.Identifier)))
			{
				return false;
			}
			return true;
		...
		public static AttributionLogin DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, attributionLogin);
