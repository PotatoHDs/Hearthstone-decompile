...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class ThirdPartyPurchaseCompletedSuccess : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (thirdPartyPurchaseCompletedSuccess == null)
			{
				return false;
			}
			if (HasPlayer != thirdPartyPurchaseCompletedSuccess.HasPlayer || (HasPlayer && !Player.Equals(thirdPartyPurchaseCompletedSuccess.Player)))
			{
				return false;
			}
			if (HasDeviceInfo != thirdPartyPurchaseCompletedSuccess.HasDeviceInfo || (HasDeviceInfo && !DeviceInfo.Equals(thirdPartyPurchaseCompletedSuccess.DeviceInfo)))
			{
				return false;
			}
			if (HasTransactionId != thirdPartyPurchaseCompletedSuccess.HasTransactionId || (HasTransactionId && !TransactionId.Equals(thirdPartyPurchaseCompletedSuccess.TransactionId)))
			{
				return false;
			}
			if (HasProductId != thirdPartyPurchaseCompletedSuccess.HasProductId || (HasProductId && !ProductId.Equals(thirdPartyPurchaseCompletedSuccess.ProductId)))
			{
				return false;
			}
			if (HasBpayProvider != thirdPartyPurchaseCompletedSuccess.HasBpayProvider || (HasBpayProvider && !BpayProvider.Equals(thirdPartyPurchaseCompletedSuccess.BpayProvider)))
			{
				return false;
			}
			return true;
		...
		public static ThirdPartyPurchaseCompletedSuccess DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, thirdPartyPurchaseCompletedSuccess);
