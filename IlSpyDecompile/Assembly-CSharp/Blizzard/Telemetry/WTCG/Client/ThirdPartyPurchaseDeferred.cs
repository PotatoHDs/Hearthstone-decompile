...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class ThirdPartyPurchaseDeferred : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (thirdPartyPurchaseDeferred == null)
			{
				return false;
			}
			if (HasPlayer != thirdPartyPurchaseDeferred.HasPlayer || (HasPlayer && !Player.Equals(thirdPartyPurchaseDeferred.Player)))
			{
				return false;
			}
			if (HasDeviceInfo != thirdPartyPurchaseDeferred.HasDeviceInfo || (HasDeviceInfo && !DeviceInfo.Equals(thirdPartyPurchaseDeferred.DeviceInfo)))
			{
				return false;
			}
			if (HasTransactionId != thirdPartyPurchaseDeferred.HasTransactionId || (HasTransactionId && !TransactionId.Equals(thirdPartyPurchaseDeferred.TransactionId)))
			{
				return false;
			}
			if (HasProductId != thirdPartyPurchaseDeferred.HasProductId || (HasProductId && !ProductId.Equals(thirdPartyPurchaseDeferred.ProductId)))
			{
				return false;
			}
			return true;
		...
		public static ThirdPartyPurchaseDeferred DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, thirdPartyPurchaseDeferred);
