...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class WelcomeQuestsAcknowledged : IProtoBuf
	{
		...
		public override int GetHashCode()
		{
			...
			{
				num ^= QuestAckDuration.GetHashCode();
			}
			return num;
		}
		...
		public override bool Equals(object obj)
		{
			...
			if (welcomeQuestsAcknowledged == null)
			{
				return false;
			}
			if (HasPlayer != welcomeQuestsAcknowledged.HasPlayer || (HasPlayer && !Player.Equals(welcomeQuestsAcknowledged.Player)))
			{
				return false;
			}
			if (HasDeviceInfo != welcomeQuestsAcknowledged.HasDeviceInfo || (HasDeviceInfo && !DeviceInfo.Equals(welcomeQuestsAcknowledged.DeviceInfo)))
			{
				return false;
			}
			if (HasQuestAckDuration != welcomeQuestsAcknowledged.HasQuestAckDuration || (HasQuestAckDuration && !QuestAckDuration.Equals(welcomeQuestsAcknowledged.QuestAckDuration)))
			{
				return false;
			}
			return true;
		...
		public static WelcomeQuestsAcknowledged DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, welcomeQuestsAcknowledged);
