...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class ThirdPartyReceiptConsumed : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (thirdPartyReceiptConsumed == null)
			{
				return false;
			}
			if (HasPlayer != thirdPartyReceiptConsumed.HasPlayer || (HasPlayer && !Player.Equals(thirdPartyReceiptConsumed.Player)))
			{
				return false;
			}
			if (HasDeviceInfo != thirdPartyReceiptConsumed.HasDeviceInfo || (HasDeviceInfo && !DeviceInfo.Equals(thirdPartyReceiptConsumed.DeviceInfo)))
			{
				return false;
			}
			if (HasTransactionId != thirdPartyReceiptConsumed.HasTransactionId || (HasTransactionId && !TransactionId.Equals(thirdPartyReceiptConsumed.TransactionId)))
			{
				return false;
			}
			return true;
		...
		public static ThirdPartyReceiptConsumed DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, thirdPartyReceiptConsumed);
