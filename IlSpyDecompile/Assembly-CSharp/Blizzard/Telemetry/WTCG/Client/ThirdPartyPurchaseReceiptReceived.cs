...
namespace Blizzard.Telemetry.WTCG.Client
{
	public class ThirdPartyPurchaseReceiptReceived : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (thirdPartyPurchaseReceiptReceived == null)
			{
				return false;
			}
			if (HasPlayer != thirdPartyPurchaseReceiptReceived.HasPlayer || (HasPlayer && !Player.Equals(thirdPartyPurchaseReceiptReceived.Player)))
			{
				return false;
			}
			if (HasDeviceInfo != thirdPartyPurchaseReceiptReceived.HasDeviceInfo || (HasDeviceInfo && !DeviceInfo.Equals(thirdPartyPurchaseReceiptReceived.DeviceInfo)))
			{
				return false;
			}
			if (HasTransactionId != thirdPartyPurchaseReceiptReceived.HasTransactionId || (HasTransactionId && !TransactionId.Equals(thirdPartyPurchaseReceiptReceived.TransactionId)))
			{
				return false;
			}
			if (HasProductId != thirdPartyPurchaseReceiptReceived.HasProductId || (HasProductId && !ProductId.Equals(thirdPartyPurchaseReceiptReceived.ProductId)))
			{
				return false;
			}
			return true;
		...
		public static ThirdPartyPurchaseReceiptReceived DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, thirdPartyPurchaseReceiptReceived);
