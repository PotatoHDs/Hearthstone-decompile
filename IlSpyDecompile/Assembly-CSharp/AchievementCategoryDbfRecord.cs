...
public class AchievementCategoryDbfRecord : DbfRecord
{
	...
	public List<AchievementSubcategoryDbfRecord> Subcategories => GameDbf.AchievementSubcategory.GetRecords((AchievementSubcategoryDbfRecord r) => r.AchievementCategoryId == base.ID);
