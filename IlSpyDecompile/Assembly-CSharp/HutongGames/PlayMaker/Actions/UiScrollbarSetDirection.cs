	...
	public class UiScrollbarSetDirection : ComponentAction<UnityEngine.UI.Scrollbar>
	{
		...
		private void DoSetValue()
		{
			if (!(scrollbar == null))
			{
				...
				{
					scrollbar.direction = (UnityEngine.UI.Scrollbar.Direction)(object)direction.Value;
				}
				else
				{
					scrollbar.SetDirection((UnityEngine.UI.Scrollbar.Direction)(object)direction.Value, includeRectLayouts.Value);
				}
			}
		}
