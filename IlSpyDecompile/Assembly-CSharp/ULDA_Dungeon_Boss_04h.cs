...
public class ULDA_Dungeon_Boss_04h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> list = new List<string> { VO_ULDA_BOSS_04h_NashTheGreatworm_Death_01, VO_ULDA_BOSS_04h_NashTheGreatworm_Defeat_01, VO_ULDA_BOSS_04h_NashTheGreatworm_EmoteResponse_01, VO_ULDA_BOSS_04h_NashTheGreatworm_Intro_01 };
		SetBossVOLines(list);
