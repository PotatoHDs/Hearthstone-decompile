...
namespace Hearthstone.DungeonCrawl
{
	public class DungeonCrawlDataPvP : IDungeonCrawlData
	{
		...
		public DungeonCrawlDataPvP(DataSet data)
		{
			m_data = data;
			...
			IsDevMode = false;
			VisualStyle = DungeonRunVisualStyle.PVPDR;
		}
		...
		{
			return AdventureUtils.IsValidLoadoutForSelectedAdventure(m_data.m_selectedAdventure, m_data.m_selectedMode, GetMission(), SelectedHeroClass, (int)SelectedHeroPowerDbId, (int)SelectedDeckId, (int)SelectedLoadoutTreasureDbId);
		}
	}
}
