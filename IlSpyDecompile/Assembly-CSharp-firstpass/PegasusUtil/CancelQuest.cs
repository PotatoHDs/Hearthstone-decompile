...
namespace PegasusUtil
{
	public class CancelQuest : IProtoBuf
	{
		...
		{
			return GetType().GetHashCode() ^ QuestId.GetHashCode();
		}
		...
		public override bool Equals(object obj)
		{
			...
			if (!QuestId.Equals(cancelQuest.QuestId))
			{
				return false;
			}
			return true;
		...
		public static CancelQuest DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, cancelQuest);
			return cancelQuest;
		}
		...
		{
			return 0 + ProtocolParser.SizeOfUInt64((ulong)QuestId) + 1;
		}
	}
}
