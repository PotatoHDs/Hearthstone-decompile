...
namespace bnet.protocol.channel.v2
{
	public class SetPrivacyLevelRequest : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (setPrivacyLevelRequest == null)
			{
				return false;
			}
			if (HasAgentId != setPrivacyLevelRequest.HasAgentId || (HasAgentId && !AgentId.Equals(setPrivacyLevelRequest.AgentId)))
			{
				return false;
			}
			if (HasChannelId != setPrivacyLevelRequest.HasChannelId || (HasChannelId && !ChannelId.Equals(setPrivacyLevelRequest.ChannelId)))
			{
				return false;
			}
			if (HasPrivacyLevel != setPrivacyLevelRequest.HasPrivacyLevel || (HasPrivacyLevel && !PrivacyLevel.Equals(setPrivacyLevelRequest.PrivacyLevel)))
			{
				return false;
			}
			return true;
		...
		{
			return ProtobufUtil.ParseFrom<SetPrivacyLevelRequest>(bs);
		}
		...
		public static SetPrivacyLevelRequest DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, setPrivacyLevelRequest);
