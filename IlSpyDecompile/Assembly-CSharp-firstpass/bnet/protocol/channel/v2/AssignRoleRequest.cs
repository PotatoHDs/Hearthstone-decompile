...
namespace bnet.protocol.channel.v2
{
	public class AssignRoleRequest : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (HasAgentId != assignRoleRequest.HasAgentId || (HasAgentId && !AgentId.Equals(assignRoleRequest.AgentId)))
			{
				return false;
			}
			if (HasChannelId != assignRoleRequest.HasChannelId || (HasChannelId && !ChannelId.Equals(assignRoleRequest.ChannelId)))
			{
				return false;
			}
			if (HasAssignment != assignRoleRequest.HasAssignment || (HasAssignment && !Assignment.Equals(assignRoleRequest.Assignment)))
			{
				return false;
			}
			return true;
		...
		{
			return ProtobufUtil.ParseFrom<AssignRoleRequest>(bs);
		}
		...
		public static AssignRoleRequest DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, assignRoleRequest);
