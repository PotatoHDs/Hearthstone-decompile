...
namespace bnet.protocol.game_utilities.v2.client
{
	...
	{
		private List<bnet.protocol.v2.Variant> _AttributeValue = new List<bnet.protocol.v2.Variant>();

		public List<bnet.protocol.v2.Variant> AttributeValue
		{
			get
			{
		...
		public List<bnet.protocol.v2.Variant> AttributeValueList => _AttributeValue;

		public int AttributeValueCount => _AttributeValue.Count;

		public bool IsInitialized => true;

		public void AddAttributeValue(bnet.protocol.v2.Variant val)
		{
		...
		public void SetAttributeValue(List<bnet.protocol.v2.Variant> val)
		{
			AttributeValue = val;
		}
		...
		public override int GetHashCode()
		{
			...
			foreach (bnet.protocol.v2.Variant item in AttributeValue)
			{
		...
		public static GetAllValuesForAttributeResponse Deserialize(Stream stream, GetAllValuesForAttributeResponse instance, long limit)
		{
			...
			{
				instance.AttributeValue = new List<bnet.protocol.v2.Variant>();
			}
			while (true)
			{
				...
				case -1:
					break;
				case 10:
					instance.AttributeValue.Add(bnet.protocol.v2.Variant.DeserializeLengthDelimited(stream));
					continue;
				default:
				{
		...
		public static void Serialize(Stream stream, GetAllValuesForAttributeResponse instance)
		{
			...
			foreach (bnet.protocol.v2.Variant item in instance.AttributeValue)
			{
				stream.WriteByte(10);
				ProtocolParser.WriteUInt32(stream, item.GetSerializedSize());
				bnet.protocol.v2.Variant.Serialize(stream, item);
			}
		}
