...
namespace bnet.protocol.friends.v1
{
	public class GetFriendListRequest : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (getFriendListRequest == null)
			{
				return false;
			}
			if (HasAgentId != getFriendListRequest.HasAgentId || (HasAgentId && !AgentId.Equals(getFriendListRequest.AgentId)))
			{
				return false;
			}
			return true;
		...
		{
			return ProtobufUtil.ParseFrom<GetFriendListRequest>(bs);
		}
		...
		public static GetFriendListRequest DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, getFriendListRequest);
