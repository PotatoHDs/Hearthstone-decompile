...
namespace bnet.protocol.games.v1
{
	public class UnsubscribeRequest : IProtoBuf
	{
		...
		{
			return GetType().GetHashCode() ^ SubscriptionId.GetHashCode();
		}
		...
		public override bool Equals(object obj)
		{
			...
			if (!SubscriptionId.Equals(unsubscribeRequest.SubscriptionId))
			{
				return false;
			}
			return true;
		...
		{
			return 0 + ProtocolParser.SizeOfUInt64(SubscriptionId) + 1;
		}
	}
}
