...
namespace BobNetProto
{
	public class DeadendUtil : IProtoBuf
	{
		...
		public override bool Equals(object obj)
		{
			...
			if (HasReply1 != deadendUtil.HasReply1 || (HasReply1 && !Reply1.Equals(deadendUtil.Reply1)))
			{
				return false;
			}
			if (HasReply2 != deadendUtil.HasReply2 || (HasReply2 && !Reply2.Equals(deadendUtil.Reply2)))
			{
				return false;
			}
			if (HasReply3 != deadendUtil.HasReply3 || (HasReply3 && !Reply3.Equals(deadendUtil.Reply3)))
			{
				return false;
			}
			return true;
		...
		public static DeadendUtil DeserializeLengthDelimited(Stream stream)
		{
			...
			DeserializeLengthDelimited(stream, deadendUtil);
			return deadendUtil;
		}
