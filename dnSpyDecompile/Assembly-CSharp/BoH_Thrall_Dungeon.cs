...
{
	// Token: 0x06004A42 RID: 19010 RVA: 0x0018B6FC File Offset: 0x001898FC
	...
	// Token: 0x06004A43 RID: 19011 RVA: 0x0017BF3A File Offset: 0x0017A13A
	public sealed override AdventureDbId GetAdventureID()
	{
		return AdventureDbId.BOH;
	}

	// Token: 0x06004A44 RID: 19012 RVA: 0x0018B780 File Offset: 0x00189980
	public static BoH_Thrall_Dungeon InstantiateTemplate_SoloDungeonMissionEntityForBoss(List<Network.PowerHistory> powerList, Network.HistCreateGame createGame)
	{
		string opposingHeroCardID = GenericDungeonMissionEntity.GetOpposingHeroCardID(powerList, createGame);
		Log.All.PrintError("BoH_Thrall_Dungeon.InstantiateTemplate_SoloDungeonMissionEntityForBoss() - Found unsupported enemy Boss {0}.", new object[]
		{
			opposingHeroCardID
		});
		return new BoH_Thrall_Dungeon();
	}

	// Token: 0x06004A45 RID: 19013 RVA: 0x0018B7B3 File Offset: 0x001899B3
	...
	// Token: 0x06004A46 RID: 19014 RVA: 0x0018B7C9 File Offset: 0x001899C9
	...
	// Token: 0x06004A47 RID: 19015 RVA: 0x0018B7D8 File Offset: 0x001899D8
