...
{
	// Token: 0x06004BE2 RID: 19426 RVA: 0x00191B7C File Offset: 0x0018FD7C
	...
	// Token: 0x06004BE3 RID: 19427 RVA: 0x0017BF3A File Offset: 0x0017A13A
	public sealed override AdventureDbId GetAdventureID()
	{
		return AdventureDbId.BOH;
	}

	// Token: 0x06004BE4 RID: 19428 RVA: 0x00191C00 File Offset: 0x0018FE00
	public static BoH_Valeera_Dungeon InstantiateTemplate_SoloDungeonMissionEntityForBoss(List<Network.PowerHistory> powerList, Network.HistCreateGame createGame)
	{
		string opposingHeroCardID = GenericDungeonMissionEntity.GetOpposingHeroCardID(powerList, createGame);
		Log.All.PrintError("BoH_Valeera_Dungeon.InstantiateTemplate_SoloDungeonMissionEntityForBoss() - Found unsupported enemy Boss {0}.", new object[]
		{
			opposingHeroCardID
		});
		return new BoH_Valeera_Dungeon();
	}

	// Token: 0x06004BE5 RID: 19429 RVA: 0x00191C33 File Offset: 0x0018FE33
	...
	// Token: 0x06004BE6 RID: 19430 RVA: 0x00191C49 File Offset: 0x0018FE49
	...
	// Token: 0x06004BE7 RID: 19431 RVA: 0x00191C58 File Offset: 0x0018FE58
